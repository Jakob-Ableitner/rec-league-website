    ...
    <div class="centerBoxTop"> 
      ...
      <div class="centerBoxRight">
          <table class="hoverTable">
			...
			<tr>
              <td class="wide-column">${tempTeam.teamName}</td>
              <td>${tempTeam.wins}</td>
          ...
          <c:forEach var="tempGame" items="${games}">
           <c:choose>
            ...
            <div class="scheduleBox">
              <div class="teams">
                <div class="team1">
                  <div>${tempGame.team1.teamName}</div>
                  <div>${tempGame.team1Score}</div>
                </div>
                <div class="team2">
                  <div>${tempGame.team2.teamName}</div>
                  <div>${tempGame.team2Score}</div>
                </div>
              </div>
              <div class="scheduleBoxRight">
                <div class="dateOrLoc"><fmt:formatDate pattern = "MM/dd/YYYY" value = "${tempGame.date}" /></div>
                <div class="dateOrLoc">${tempGame.location}</div>
              </div>
            </div>
            </c:when>    
    		<c:otherwise>

...
<html lang="en">
  <head>
    ...
    <body>
      ...
      <nav class="navbar navbar-expand-lg navbar-light bg-light">
        ...
        <div class="dropdown">
          ...
          <div>
            <a class="nav-link active" href="<c:url value = "http://localhost:8081/home"/>">Admin Log In</a>
        </div>
        </div>
      </nav>
      ...
      <header>
        <div class="header-container-inner">
          <h1>Rochester Broomball Rec League</h1>
        </div>
    </header>
    ...
    <section>
      <div class="container">
        <p>
          Welcome to the Rochester Broomball Rec League Home Page! Feel free to look at the current standings and schedule. You can also check out the players contact page if you need to get ahold of anyone. Please register if you haven't already.
        </p>
      </div>
    </section>
    
  <div class="container">
  <footer class="d-flex flex-wrap justify-content-center py-3 my-4 border-top footer-extra">
